function HeaderComponent() {
    ...
    label.addEventListener("click",() => {
        let si = document.getElementById("signInForm")
        si.remove();
    })

   label.addEventListener("click",()=>{
    let si=document.getElementById("signUpForm");
    si.remove();
   })
...
function signInPage() {
    ...
    first.setAttribute(
        "style",
        "height:450px; width:500px; border: 2px solid black; background: white; position: absolute; top: 100px; left: 50%; transform: translateX(-50%); padding: 20px; text-align: center; box-shadow: 10px 10px 10px rgba(49, 48, 48, 0.6); color:white;"
    );
    first.setAttribute("class", "bg-dark");
    ...
    lab1.setAttribute("style", "display: block; text-align: left; font-weight: bold; margin-top: 10px;");
    first.appendChild(lab1);

    let userName = document.createElement("input");
    userName.setAttribute("type", "text");
    userName.setAttribute("placeholder", "Enter User Name");
    userName.setAttribute("id", "usernamedata");
    userName.setAttribute("style", "width: 100%; padding: 8px;");
    first.appendChild(userName);

    let lab2 = document.createElement("label");
    lab2.innerText = "Password";
    ...
    password.setAttribute("id", "passworddata");
    ...
    let signbtn = document.createElement("span");
    signbtn.setAttribute("type", "button");
    signbtn.setAttribute("class", "signbtn-success m-4 text-primary row align-item-center justify-content-center");
    signbtn.setAttribute("style", "margin-top: 30px;");
    signbtn.innerText = "create account Sign-Up ";
    signbtn.addEventListener("click", function () {
        signUpPage();
    });

    btn.addEventListener("click", function () {
        let username = document.getElementById("usernamedata").value.trim();
        let password = document.getElementById("passworddata").value.trim();
...
function signUpPage() {
    ...
    // Create the sign-up form div
    let second = document.createElement("div");
    second.setAttribute("id", "signUpForm");
    second.setAttribute("class", "bg-dark");
    second.setAttribute(
        "style",
        "height:450px; width:500px; border: 2px solid black; background: white; position: absolute; top: 100px; left: 50%; transform: translateX(-50%); padding: 20px; text-align: center; box-shadow: 10px 10px 10px rgba(90, 87, 87, 0.4); color:white;"
    );
    ...
    userName.setAttribute("style", "width: 100%; padding: 0px;");
    ...
    btn.addEventListener("click", function () {
        ...
        alert("Sign-up successful! User added to localStorage.");
        second.remove();
    });
...
function CardComponent() {
    ...
    for (let product of data) {
        ...
        buttonViewMore.setAttribute("class", "btn btn-warning");
...
function ViewMoreComponent(product) {
    ...
    mulitImage.setAttribute("class", "d-flex flex-row justify-content-around align-items-center");
    ...
    productDetailsContainer.setAttribute("class", "d-flex flex-column p-3");
    ...
    buyNow.addEventListener("click", function checkUserAndAddToCart(title) {
        let isLoggedIn = sessionStorage.getItem("currentUser"); // Check current session login status
...
function displayProduct(product) {
    ...
    container.setAttribute(
        "style",
        "  height:370px; width:500px; border: 0px solid black; background: white; position: absolute; top: 100px; left: 50%; transform: translate(-50%); padding: 20px; text-align: center; box-shadow: 10px 10px 10px rgba(90, 87, 87, 0.4);"

    );

    // Product Image
    let productImage = document.createElement("img");
    productImage.src = product.thumbnail; // Replace with actual image path
    productImage.setAttribute("style", "width: 200px; height: 200px; border: 1px solid black;");
    container.appendChild(productImage);

    let titleLabel = document.createElement("p");
    titleLabel.innerHTML = `<b>${product.title} </b>`;
    titleLabel.setAttribute("id", "title");
    container.appendChild(titleLabel);
    // Price Label
    let priceLabel = document.createElement("p");
    priceLabel.innerText = "₹" + product.price;
    priceLabel.setAttribute("id", "price");
    ...
    quantityInput.setAttribute("style", "width: 50px; margin-left: 5px;");
    quantityInput.addEventListener("input", function updateTotal() {
        let quantity = parseInt(quantityInput.value);
        let price = product.price; // Base price
        totalPrice.innerText = "Total:  ₹" + (quantity * price);
    });
    ...
    totalPrice.innerText = "Total: ₹" + product.price;
    container.appendChild(totalPrice);

    // Payment Method Selection
    let paymentLabel = document.createElement("p");
    ...
    paymentSelect.setAttribute("style", "width: 250px; padding: 5px;");
    let methods = ["Credit Card", "Debit Card", "PayPal", "UPI", "Cash on Delivery"];
    ...
    buyButton.setAttribute("style", "margin-top: 15px; padding: 10px 20px; cursor: pointer; background-color: green; color: white; border: none;");
